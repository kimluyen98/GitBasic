<?php
    ...
    $path = $path.'/Module/Other/messenger_1_0_0/';
?>
...
<div class="messenger_1_0_0">
    <a class="container" target="_blank" rel="nofollow">
...
<script type="text/javascript">
	 $(".messenger_1_0_0 a").on("click",function(){
		 window.open('https://www.messenger.com/t/trungtamphauthuatthammyLGBThongha','menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=500','_blank');
	 });
</script>