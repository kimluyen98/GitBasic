<?php 
  echo '
    <style>
      ...
      .popup_call_3_0_0 .popup_call_3_0_0_overlay {
      ...
      .popup_call_3_0_0_box #popup_call_3_0_0_closePopup {
      ...
      .popup_call_3_0_0 input, .popup_call_3_0_0 textarea {
        box-sizing: border-box;
        -moz-box-sizing: border-box;
      }
      .popup_call_3_0_0__header {
        display: flex;
      }
      .popup_call_3_0_0__header img {
        width: 75%;
      }
      .popup_call_3_0_0__header h2 {
        margin: 0;
        color: #283F75;
        font-weight: bold;
      ...
      .popup_call_3_0_0__content {
        margin-top: 30px;
      }
      .popup_call_3_0_0__content input,
      .popup_call_3_0_0__content textarea {
        width: 100%;
        margin-bottom: 10px;
        padding: 10px;
        border: none;
      ...
      .popup_call_3_0_0__ft {
        display: flex;
        justify-content: space-between;
        margin-top: 20px;
      }
      .popup_call_3_0_0__ft .ft-1 {
        display: flex;
      }
      .popup_call_3_0_0__ft .ft-1 .text {
        padding-left: 10px;
      }
      .popup_call_3_0_0__ft .ft-1 .text p {
        margin: 0;
        font-size: 15px;
      }
      .popup_call_3_0_0__ft .ft-1 .text b {
        color: #283F75;
        font-size: 18px;
      }
      .popup_call_3_0_0__ft .regist button {
        background: #EF4324;
        color: #fff;
        text-transform: uppercase;
        font-weight: bold;
      ...
      .popup_call_3_0_0__note {
        margin: 15px 100px 0;
        text-align: center;
        color: #000;
        font-style: italic;
      }
      .popup_call_3_0_0 .overlay_form {
        font-size: 14px;
      }
      .popup_call_3_0_0 .popup_call_3_0_0_overlay {
        position: fixed;
      ...
      .popup_call_3_0_0_box {
        position: absolute;
        width: 100%;
        top: 60px;
      }
      .popup_call_3_0_0_box article {
        background: #fff;
        z-index: 11;
        margin: 50px auto;
        padding: 20px;
      ...
      .popup_call_3_0_0_box #popup_call_3_0_0_closePopup:hover {
        transform: rotate(360deg);
      }
      .popup_call_3_0_0 .popup_call_3_0_0_clickPopup2 {
        color: #fff;
        width: 100px;
        height: 20px;
        padding: 10px;
      ...
      .popup_call_3_0_0 .popup_call_3_0_0_clickPopup2:hover {
      ...
      /*# sourceMappingURL=popup_call_3_0_0.css.map */
